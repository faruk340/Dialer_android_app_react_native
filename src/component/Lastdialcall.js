...
const Lastdialcall = (props) => {
    ...
    const dataSaveEvent = () => {
        ...
        if (selectedItems.name !== "") {
            ...
            props.passData();
            const lastdialcallData = skip.map((ele, index) => {
                return {
                    // ...ele,
                    ...
                    remark: dataRemark ? dataRemark : "NA",
    ...
    const appinmentSubmitEvent = () => {
        ...
        if (appo_date_time !== "" && appo_time !== "" && appo_purpose !== "" && appo_status !== "") {
            props.passSaveDataEvents();
            props.passData();
            const newappinmentData = skip.map((ele, index) => {
                return {
                    ...ele,
            ...
            const newappinmentData2 = skip.map((ele, index) => {
                return {
                    ...ele,
                    listid: ele.list_id,
                    customer_whatsapp_no: appinmentData.customer_whatsapp_no ? appinmentData.customer_whatsapp_no : "NA",
                    ...
                    appointment_status: appinmentData.appointment_status ? appinmentData.appointment_status : "NA",
                    status: "Appointment",
                    remarks: appinmentData.appointment_remarks ? appinmentData.appointment_remarks : "NA",
                    appointment_remarks: appinmentData.appointment_remarks ? appinmentData.appointment_remarks : "NA",
                    cmpid: MemberDetails.cmpid ? MemberDetails.cmpid : "NA",
                    member_id: MemberDetails.member_id ? MemberDetails.member_id : "NA",
                    member_name: MemberDetails.member_name ? MemberDetails.member_name : "NA",
            ...
            CustomerCreateModule.createAppointment(JSON.stringify(newappinmentData))
                .then((res) => {
                    ...
                    if (res) {
                        console.log("Res:" + res);
                        // alert("Your contact is created")
                        CustomerCreateModule.createRemaksResponseup(JSON.stringify(newappinmentData2))
                            .then((res) => {
                                // setloading(false)
    ...
    function followUpDataSubmitEventToast() {
        Toast.show({
            type: 'success',
            // text1: 'Hello',
            text1: 'FollowUp Done',
    ...
    const followUpDataSubmitEvent = () => {
        ...
        if (rem_date !== "" && rem_time !== "" && rem_remarks !== "") {
            props.passSaveDataEvents();
            props.passData();
            const newFollowUpData = skip.map((ele, index) => {
                return {
                    ...ele,
                    ...followUpData,
                    cmpid: MemberDetails.cmpid ? MemberDetails.cmpid : "NA",
            ...
            const newFollowUpData2 = skip.map((ele, index) => {
                return {
                    ...ele,
                    listid: ele.list_id,
                    customer_whatsapp_no: followUpData.customer_whatsapp_no ? followUpData.customer_whatsapp_no : "NA",
                    status: "reminder",
                    remarks: followUpData.reminder_remark ? followUpData.reminder_remark : "NA",
                    cmpid: MemberDetails.cmpid ? MemberDetails.cmpid : "NA",
                    member_name: MemberDetails.member_name ? MemberDetails.member_name : "NA",
                    member_location: MemberDetails.member_location ? MemberDetails.member_location : "NA",
                    member_skip_call: MemberDetails.member_skip_call ? MemberDetails.member_skip_call : "NA",
            ...
            CustomerCreateModule.createFollowup(JSON.stringify(newFollowUpData))
                .then((res) => {
                    if (res) {
                        ...
                        CustomerCreateModule.createRemaksResponseup(JSON.stringify(newFollowUpData2))
                            .then((res) => {
                                // setloading(false)
                        ...
                        <View style={styles.userInfoSection}>
                            <View style={styles.userInfo}>
                                ...
                                <View style={styles.userInfoDetails}>
                                    <View>
                                        <Text style={{ fontSize: 16, color: "#fff", paddingLeft: 3, paddingBottom: 5 }}>{customerLastCallDetails.customer_name}</Text>
                                    </View>
                                    <View style={styles.userInfoDetailsIcon}>
                                        <Feather name='smartphone' size={25} color="#fff" />
                                        <Text style={[styles.white, styles.fontOne]}>{customerLastCallDetails.customer_mob_no}</Text>
                                    </View>
                                </View>
                            </View>
                        </View>
                        ...
                        <View style={[styles.listItemContainer]}>
                            <View style={styles.listItems}>
                                <View style={styles.listItem}>
                                    ...
                                    <Text style={[styles.itemValue, styles.fontOne]}> {customerLastCallDetails.customer_whatsapp_no}</Text>
                                </View>
                                <View style={styles.listItem}>
                                    <EvilIcons name='location' color="#fff" size={30} style={{ marginLeft: -6 }} />
                                    <Text style={[styles.itemValue, styles.fontOne, { marginLeft: -6 }]}> {customerLastCallDetails.customer_location}</Text>
                                </View>
                                <View style={styles.listItem}>
                                    <FontAwesome5 name='car' color="#fff" size={20} />
                                    <Text style={[styles.itemValue, styles.fontOne]}> {customerLastCallDetails.op1}</Text>
                                </View>
                                <View style={styles.listItem}>
                                    <Fontisto name='date' color="#fff" size={20} />
                                    <Text style={[styles.itemValue, styles.fontOne]}> {customerLastCallDetails.op3}</Text>
                                </View>
                                <View style={[styles.listItem]}>
                                    <MaterialCommunityIcons name='update' color="#fff" size={25} />
                                    <Text style={[styles.itemValue, styles.fontOne]}> {customerLastCallDetails.op4}</Text>
                                </View>
                            </View>
                        </View>
                    </View>
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    <View style={styles.outerappointmentInputField}>
                        <View style={styles.appointmentInputField}>
                            <Text style={{ fontSize: 20, textAlign: "center", margin: 15 }}>Appointment</Text>
                            ...
                            <View style={[styles.inputLabelOne, { marginBottom: 0 }]}>
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    <View style={styles.outerFollowUpInputField}>
                        <View style={styles.appointmentInputField}>
                            ...
                            <View style={styles.inputLabelDateTime}>
                                <View style={[styles.inputDate, { marginBottom: -15 }]}>
                                ...
                                <View style={[styles.inputTime, { marginBottom: -15 }]}>
